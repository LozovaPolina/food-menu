...
;
	...
	function onStart(e: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) {
		e.preventDefault();
		setIsSwiping(true);
		...
		>
			<ul
				className={`flex gap-4 min-w-full flex-row 
		         ${isSwiping ? 'transition-none' : 'transition-transform duration-500 ease-[cubic-bezier(0.25,0.8,0.25,1)]'} 
